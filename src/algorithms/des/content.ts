...
export const content: AlgorithmContent = {
  ...
  sources: [
    {
      label: 'FIPS 46-3: Data Encryption Standard',
      url: 'https://csrc.nist.gov/files/pubs/fips/46-3/final/docs/fips46-3.pdf',
      note: 'Withdrawn in 2005, and the source of the standard test vector used here.',
    },
    {
      label: 'EFF, Cracking DES (1998)',
      url: 'https://www.eff.org/files/2013/12/23/DESCracker_HowItWorks.pdf',
      note: 'The machine that broke a 56-bit key in days and ended the argument.',
    },
  ],
};
